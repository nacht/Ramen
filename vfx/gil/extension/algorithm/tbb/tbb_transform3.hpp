...
template<class View1, class View2, class View3, class View4, class Fun>
tbb_transform3_pixels_fun<View1, View2, View3, View4, Fun> make_tbb_transform3_pixels_fun( const View1& src1, const View2& src2,
...
template<class View1, class View2, class View3, class View4, class Fun>
GIL_FORCEINLINE void tbb_transform_pixels( const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f)
{
...
template<class View1, class View2, class View3, class View4, class Fun>
GIL_FORCEINLINE void tbb_transform_pixels( const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f, const tbb::auto_partitioner& part)
{
    tbb::parallel_for( tbb::blocked_range<std::size_t>( 0, src1.height()), detail::make_tbb_transform3_pixels_fun( src1, src2, src3, dst, f), part);
}

template<class View1, class View2, class View3, class View4, class Fun>
GIL_FORCEINLINE void tbb_transform_pixels( const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f, const tbb::simple_partitioner& part)
{
    tbb::parallel_for( tbb::blocked_range<std::size_t>( 0, src1.height()), detail::make_tbb_transform3_pixels_fun( src1, src2, src3, dst, f), part);
}

template<class View1, class View2, class View3, class View4, class Fun>
GIL_FORCEINLINE void tbb_transform_pixels( const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f, tbb::affinity_partitioner& part)
{
    tbb::parallel_for( tbb::blocked_range<std::size_t>( 0, src1.height()), detail::make_tbb_transform3_pixels_fun( src1, src2, src3, dst, f), part);
}
