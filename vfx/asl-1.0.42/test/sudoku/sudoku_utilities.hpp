...
void setup_links(sudoku_t& puzzle, adobe::dancing_links<dlx_rows_k, dlx_cols_k>& links)
{
    /*
...
{
    adobe::dancing_links<dlx_rows_k, dlx_cols_k> links;
...
#if 1
        double last_split(timer.last_split());
