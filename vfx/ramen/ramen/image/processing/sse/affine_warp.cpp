...
{
    generic::affine_warp<sse::bilinear_sampler_t>( src_area, src, dst_area, dst, xform, inv_xform);
}
...
void affine_warp_bicubic( const Imath::Box2i& src_area, const const_image_view_t& src,
		     ...
		     const Imath::M33d& xform, const Imath::M33d& inv_xform)
{
    generic::affine_warp<sse::bicubic_sampler_t>( src_area, src, dst_area, dst, xform, inv_xform);
}
...
void affine_warp_bilinear_tile( const Imath::Box2i& src_area, const const_image_view_t& src,
		     ...
		     const Imath::M33d& xform, const Imath::M33d& inv_xform)
{
    generic::affine_warp_non_black_border_mode<sse::bilinear_tile_sampler_t>( src_area, src, dst_area, dst, xform, inv_xform);
}
...
void affine_warp_bilinear_mirror( const Imath::Box2i& src_area, const const_image_view_t& src,
		     ...
		     const Imath::M33d& xform, const Imath::M33d& inv_xform)
{
    generic::affine_warp_non_black_border_mode<sse::bilinear_mirror_sampler_t>( src_area, src, dst_area, dst, xform, inv_xform);
}
