...
{
    generic::projective_warp<sse::bilinear_sampler_t>( src_area, src, dst_area, dst, xform, inv_xform);
}
...
void projective_warp_bicubic( const Imath::Box2i& src_area, const const_image_view_t& src,
		     ...
		     const Imath::M33d& xform, const Imath::M33d& inv_xform)
{
    generic::projective_warp<sse::bicubic_sampler_t>( src_area, src, dst_area, dst, xform, inv_xform);
}
